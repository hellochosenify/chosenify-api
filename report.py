...
def generate_report(report_data):
    ...
    return f"""<div style="font-family:Arial,sans-serif;padding:32px;background:#f4f7fb;color:#1f2937;"><div style="max-width:860px;margin:0 auto;background:#ffffff;border:1px solid #d9e2ec;border-radius:20px;padding:32px;box-shadow:0 18px 40px rgba(15,23,42,0.08);"><h1 style="margin:0 0 10px;font-size:30px;color:#0f172a;">Career Personality Report</h1><p style="margin:0 0 24px;font-size:16px;line-height:1.8;color:#475569;">A structured view of your strongest tendencies, best-fit roles, and next growth opportunities.</p><div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:12px;margin-bottom:28px;"><div style="background:#eef4ff;border-radius:16px;padding:16px;"><div style="font-size:12px;text-transform:uppercase;letter-spacing:0.08em;color:#64748b;">Personality Type</div><div style="margin-top:6px;font-size:20px;font-weight:700;color:#0f172a;">{personality_type}</div></div><div style="background:#ecfdf5;border-radius:16px;padding:16px;"><div style="font-size:12px;text-transform:uppercase;letter-spacing:0.08em;color:#64748b;">Top Trait</div><div style="margin-top:6px;font-size:20px;font-weight:700;color:#0f172a;">{top_trait}</div></div><div style="background:#fff7ed;border-radius:16px;padding:16px;"><div style="font-size:12px;text-transform:uppercase;letter-spacing:0.08em;color:#64748b;">Lowest Score</div><div style="margin-top:6px;font-size:20px;font-weight:700;color:#0f172a;">{lowest_trait}</div></div></div><section style="margin-bottom:28px;"><h2 style="margin:0 0 12px;font-size:22px;color:#0f172a;">1. Overview</h2><p style="margin:0;font-size:16px;line-height:1.8;color:#334155;">Your current profile aligns with the <strong>{personality_type}</strong> personality type. This suggests your strongest performance comes when your work reflects how you naturally think, contribute, and stay motivated.</p></section><section style="margin-bottom:28px;"><h2 style="margin:0 0 12px;font-size:22px;color:#0f172a;">2. Top Trait Explanation</h2><p style="margin:0;font-size:16px;line-height:1.8;color:#334155;"><strong>{top_trait}</strong> is your highest scoring dimension. {top_trait_content["summary"]}</p></section><section style="margin-bottom:28px;"><h2 style="margin:0 0 12px;font-size:22px;color:#0f172a;">3. Strengths</h2><ul style="margin:0;padding-left:20px;color:#334155;line-height:1.9;"><li>{top_trait_content["strengths"][0]}</li><li>{top_trait_content["strengths"][1]}</li><li>{top_trait_content["strengths"][2]}</li></ul></section><section style="margin-bottom:28px;"><h2 style="margin:0 0 12px;font-size:22px;color:#0f172a;">4. Weaknesses</h2><p style="margin:0 0 12px;font-size:16px;line-height:1.8;color:#334155;">Your lowest score is in <strong>{lowest_trait}</strong>, which points to a potential growth area rather than a fixed limitation.</p><ul style="margin:0;padding-left:20px;color:#334155;line-height:1.9;"><li>{lowest_trait_content["weaknesses"][0]}</li><li>{lowest_trait_content["weaknesses"][1]}</li><li>{lowest_trait_content["weaknesses"][2]}</li></ul></section><section style="margin-bottom:28px;"><h2 style="margin:0 0 12px;font-size:22px;color:#0f172a;">5. Career Matches</h2><ul style="margin:0;padding-left:20px;color:#334155;line-height:1.9;"><li>{top_trait_content["careers"][0]}</li><li>{top_trait_content["careers"][1]}</li><li>{top_trait_content["careers"][2]}</li></ul></section><section style="margin-bottom:28px;"><h2 style="margin:0 0 12px;font-size:22px;color:#0f172a;">6. Growth Plan</h2><ul style="margin:0;padding-left:20px;color:#334155;line-height:1.9;"><li>{top_trait_content["growth_plan"][0]}</li><li>{top_trait_content["growth_plan"][1]}</li><li>{top_trait_content["growth_plan"][2]}</li></ul></section><section><h2 style="margin:0 0 12px;font-size:22px;color:#0f172a;">Score Snapshot</h2><ul style="margin:0;padding-left:20px;color:#334155;line-height:1.9;"><li>Social: {scores["Social"]}</li><li>Investigative: {scores["Investigative"]}</li><li>Artistic: {scores["Artistic"]}</li><li>Enterprising: {scores["Enterprising"]}</li></ul></section></div></div>"""
